...
<li class="nav-item">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="listproduct.php">Sản phẩm</a>
            <a class="collapse-item" href="cards.html">Tồn kho</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseBrands" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chức năng:</h6>
            <a class="collapse-item" href="./brands.php">Liệt kê</a>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chức năng:</h6>
            <a class="collapse-item" href="buttons.html">Thêm mới</a>
...
<li class="nav-item">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chức năng:</h6>
            <a class="collapse-item" href="buttons.html">Ngày tạo</a>
            <a class="collapse-item" href="cards.html"></a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chức năng:</h6>
            <a class="collapse-item" href="utilities-color.html">Thông tin khách hàng</a>
            <a class="collapse-item" href="utilities-border.html">Lịch sử mua hàng</a>
        </div>
    </div>
</li>
